...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aL, request.au, true);
		} catch (e) {
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		_Utils_update(
			$author$project$Main$empty_model,
			{w: true}),
		$author$project$Main$getting_words);
};
...
var $author$project$Main$Json = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$HomePage$OneWord = F2(
	function (oneWord, descriptions) {
		return {aE: descriptions, aP: oneWord};
	});
...
var $author$project$HomePage$definitionsDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'definitions',
	$elm$json$Json$Decode$string,
	$elm$json$Json$Decode$succeed($author$project$HomePage$Definitions));
var $author$project$HomePage$descriptionDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'multiple_definitions',
	$elm$json$Json$Decode$list($author$project$HomePage$definitionsDecoder),
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'partOfSpeech',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$HomePage$Description)));
var $author$project$HomePage$wordDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'descriptions',
	$elm$json$Json$Decode$list($author$project$HomePage$descriptionDecoder),
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'one_word',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$HomePage$OneWord)));
var $author$project$HomePage$jsonDecoder = $elm$json$Json$Decode$list($author$project$HomePage$wordDecoder);
var $author$project$Main$link_to_api = 'https://api.dictionaryapi.dev/api/v2/entries/en/hello';
...
var $author$project$Main$GenWord = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Main$random_function = function (array_) {
	return A2(
		$elm$random$Random$generate,
		$author$project$Main$GenWord,
		A2(
			$elm$random$Random$int,
			0,
			$elm$core$Array$length(array_)));
};
var $author$project$GrabMaybe$takeString = function (first) {
	if (!first.$) {
		var str = first.a;
		return str;
	} else {
...
var $author$project$GrabMaybe$takeWord = function (first) {
	if (!first.$) {
		var one_word = first.a;
		return one_word;
	} else {
		return A2($author$project$HomePage$OneWord, '', _List_Nil);
	}
};
				...
				if (!result.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								aE: $author$project$GrabMaybe$takeWord(
									$elm$core$List$head(json)).aE,
								w: false
							}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$Main$def_function = function (list) {
	return A2(
		$elm$html$Html$ol,
		_List_Nil,
		A2(
...
var $author$project$Main$descriptions_html = function (list) {
	return A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2(
